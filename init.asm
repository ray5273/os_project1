...
main(void)
{
  ...
  19:	e8 34 03 00 00       	call   352 <open>
  ...
  28:	6a 00                	push   $0x0
  2a:	e8 5b 03 00 00       	call   38a <dup>
  dup(0);  // stderr
  2f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  36:	e8 4f 03 00 00       	call   38a <dup>
  3b:	83 c4 10             	add    $0x10,%esp

  for(;;){
    pid = fork();
  3e:	e8 c7 02 00 00       	call   30a <fork>
    if(pid < 0){
  ...
  50:	e8 c5 02 00 00       	call   31a <wait>
  ...
  for(;;){
    pid = fork();
  5d:	e8 a8 02 00 00       	call   30a <fork>
    if(pid < 0){
  ...
  71:	e8 0a 04 00 00       	call   480 <printf>
      exit();
  76:	e8 97 02 00 00       	call   312 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  7b:	50                   	push   %eax
  ...
  82:	68 bb 07 00 00       	push   $0x7bb
  87:	e8 be 02 00 00       	call   34a <exec>
      printf(1, "init: exec sh failed\n");
  8c:	5a                   	pop    %edx
  8d:	59                   	pop    %ecx
  8e:	68 be 07 00 00       	push   $0x7be
  93:	6a 01                	push   $0x1
...
main(void)
{
  ...
  a9:	e8 ac 02 00 00       	call   35a <mknod>
    open("console", O_RDWR);
  ae:	58                   	pop    %eax
  af:	5a                   	pop    %edx
  b0:	6a 02                	push   $0x2
  b2:	68 a0 07 00 00       	push   $0x7a0
  b7:	e8 96 02 00 00       	call   352 <open>
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 d4 07 00 00       	mov    $0x7d4,%eax
